		...
		<div id="contact" ref={ref} className={`self-stretch bg-[#009EFC] py-[82px] ${revealClass(visible, 'up')}`}>
			...
			<div className="flex justify-between items-start self-stretch mb-[108px] mx-[120px]">
				...
				<div className="flex flex-col items-start w-[346px]">
					<div className="flex flex-col items-start self-stretch mb-[21px] gap-[23px]">
						<div className="flex flex-col items-start self-stretch gap-[18px]">
							<img
								src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/uE5ydZUhPK/pp5n8iy9_expires_30_days.png"
								className="w-[74px] h-[74px] object-fill"
								alt=""
							/>
						...
						<div className="bg-white w-[326px] h-[1px]"></div>
					</div>
					<div className="flex items-center mb-4 gap-3.5">
						<img
							src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/uE5ydZUhPK/1vip9rzj_expires_30_days.png"
							className="w-[38px] h-[38px] rounded-lg object-fill"
							alt=""
						/>
						<span className="text-white text-[13px] w-[193px]">
							L2 rue des jardins, Cocody 2e étage magasin Ixina, Abidjan, Côte
							d'Ivoire
						</span>
					</div>
					<div className="flex items-center gap-3.5">
						<img
							src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/uE5ydZUhPK/6mbrbnq3_expires_30_days.png"
							className="w-[38px] h-[38px] rounded-lg object-fill"
							alt=""
						/>
						<span className="text-white text-[13px]">Téléphone : +225 0757027157</span>
					</div>
				</div>
			</div>
			<div className="self-stretch">
				<div className="self-stretch bg-white h-[1px] mb-[54px]"></div>
				<div className="flex flex-col self-stretch relative mb-[50px] ml-[67px] mr-6">
					<div className="flex flex-col items-center self-stretch absolute bottom-[-9px] right-0 left-0">
						<span className="text-white text-base font-bold">
							© Ivoir Pool . Tous droits réservés
						</span>
					</div>
					<img
						src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/uE5ydZUhPK/eqcezg98_expires_30_days.png"
						className="self-stretch h-[185px] object-fill"
						alt=""
					/>
				</div>
				<div className="self-stretch bg-white h-[1px] mb-10"></div>
